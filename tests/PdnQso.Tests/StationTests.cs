...
public class StationTests
{
    ...
    [Fact]
    public void A_Mode_Whose_Modem_Reports_A_Different_Name_Still_Builds_A_Station()
    {
        ...
        using var station = Station.Create(Options("M0LTE"), link.DeviceA, "fsk9600-il2p");
